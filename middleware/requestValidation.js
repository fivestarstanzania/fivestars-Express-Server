...
export const validateProductCreateRequest = [
  ...
  textField('description', 'Description', { required: true, min: 1, max: 5000 }),
  textField('category', 'Category', { required: true, min: 2, max: 100 }),
  textField('subcategory', 'Subcategory', { required: false, min: 1, max: 100 }),
  textField('supplierName', 'Supplier name', { required: false, min: 1, max: 150 }),
  textField('supplierContat', 'Supplier contact', { required: false, min: 1, max: 100 }),
  textField('returnPolicy', 'Return policy', { required: true, min: 1, max: 1000 }),
